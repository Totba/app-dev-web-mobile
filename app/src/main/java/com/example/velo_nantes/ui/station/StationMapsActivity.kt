...
import com.example.velo_nantes.databinding.ActivityStationMapsBinding
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        stationSelected?.let { station ->
            ...
            if(currentLocation != null){
                val stationLatLng = LatLng(currentLocation!!.latitude, currentLocation!!.longitude)
                mMap.addMarker(MarkerOptions()
                    .position(stationLatLng)
                    .title("My Position")
            ...
            val sydney = LatLng(station.latitude, station.longitude)
